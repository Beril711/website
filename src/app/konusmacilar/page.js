...
export const metadata = {
  title: 'Konuşmacılar — Mucur AI Days 2025',
  description: 'Mucur AI Days 2025 etkinliği konuşmacıları.',
};
      ...
      <section style={{ padding: '0 0 100px' }}>
        <div className="container">
          <div style={{ marginBottom: '48px' }}>
            ...
            <h2 className="section-heading">6 <span className="gradient-text">Uzman</span> İsim</h2>
          </div>
